	...
	<div class="col-sm-offset-{$formLabelWidth}">
		<div class="panel-group" id="options-panels" role="tablist" aria-multiselectable="false">
			<div class="panel panel-default">
				<div class="panel-heading" id="schedule-heading" role="button" data-toggle="collapse" href="#schedule-panel" aria-expanded="false" aria-controls="schedule-panel">
					<label class="control-label">
						Sync Schedule Configuration <span class="caret"></span>
					</label>
				</div>
				<div id="schedule-panel" class="panel-collapse collapse" role="tabpanel" aria-labelledby="schedule-heading">
			...
			<div class="panel panel-default">
				<div class="panel-heading" id="regex-heading" role="button" data-toggle="collapse" href="#regex-panel" aria-expanded="false" aria-controls="regex-panel">
					<label class="control-label">
						Regular Expression Filtering <span class="caret"></span>
					</label>
				</div>
